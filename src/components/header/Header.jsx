...
export default function Header() {
  return (
    ...
    <h3 className="developer">I build accessible, human-centered products that leave a great impression, prioritizing responsiveness and pixel-perfect user experiences.</h3>
    </container>
